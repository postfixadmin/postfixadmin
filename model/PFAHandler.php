...
abstract class PFAHandler {
     ...
     *
     * @param int - 0 is edit mode, set to 1 to switch to create mode
     * @param string - if an admin_username is specified, permissions will be restricted to the domains this admin may manage
     * @param int - 0 if logged in as user, 1 if logged in as admin or superadmin
     */
...
#                return true;
     ...
     *
     * @param bool (optional) - if false, $this->errormsg[] will not be filled in case of errors
     *
     ...
     *
     * @return bool true on successful login (i.e. password matches etc)
     */
     ...
     * @param string $token
     *
     * @return bool true on success (i.e. code matches etc)
     */
