...
<table class=form>
<tr><td>Alias:</td><td><input type=text name=address></td><td>@<? print "$sessid[domain]" ?></td></tr>
<tr><td>To:</td><td><input type=text name=goto></td><td>Where the mail needs to be send to.</td></tr>
