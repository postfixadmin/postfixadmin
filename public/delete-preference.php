 ...
 *
 * File: delete-preference.php
 * Deletes the admin preference for the default alias "To" (goto) field that the logged-in
 * admin stored from the add-alias form. Storing it happens in AliasHandler::postSave();
 * only the deletion needs an endpoint of its own, because it has to work without creating
 * an alias.
 *
 * Template File: none
 */
