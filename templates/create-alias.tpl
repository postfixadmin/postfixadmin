...
<table class="form">
   <tr>
      <td align="center" colspan="3">
         <?php print $LANG['pCreate_alias_welcome'] . "\n"; ?>
         <br />
         <br />
      </td>
   </tr>
   <tr>
      <td>
         ...
         <?php print $LANG['pCreate_alias_address'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pCreate_alias_goto'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td align="center" colspan="3">
         <input type="submit" name="submit" value="<?php print $LANG['pCreate_alias_button']; ?>" />
         </form>
      </td>
   </tr>
</table>
<p />
<?php print $LANG['pCreate_alias_catchall_text'] . "\n"; ?>
