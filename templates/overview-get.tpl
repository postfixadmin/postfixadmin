...
print "      <td>" . $LANG['pOverview_get_domain'] . "</td>\n";
print "      <td>" . $LANG['pOverview_get_aliases'] . "</td>\n";
print "      <td>" . $LANG['pOverview_get_mailboxes'] . "</td>\n";
if ($CONF['quota'] == 'YES') print "      <td>" . $LANG['pOverview_get_quota'] . "</td>\n";
print "   </tr>\n";
