...
<table class="form">
   <tr>
      <td align="center" colspan="3">
         <?php print $LANG['pCreate_mailbox_welcome'] . "\n"; ?>
         <br />
         <br />
      </td>
   </tr>
   <tr>
      <td>
         ...
         <?php print $LANG['pCreate_mailbox_username'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pCreate_mailbox_password'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pCreate_mailbox_password2'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pCreate_mailbox_name'] . ":\n"; ?>
      </td>
      <td>
...
?>
   ...
   <tr>
      <td>
         <?php print $LANG['pCreate_mailbox_mail'] . ":\n"; ?>
       </td>
      <td>
   ...
   <tr>
      <td align="center" colspan="3">
         <input type="submit" name="submit" value="<?php print $LANG['pCreate_mailbox_button']; ?>" />
         </form>
      </td>
   </tr>
</table>
