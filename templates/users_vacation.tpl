...
<table>
	...
	<tr>
		...
		<td><input name="fActiveFrom" value="{$fActiveFrom}" readonly="readonly" style="background:#eee;"/>
{literal}
...
{/literal}
	...
	<tr>
		...
		<td><input name="fActiveUntil" value="{$fActiveUntil}" readonly="readonly" style="background:#eee;"/>
{literal}
<script language="JavaScript">
	new tcal ({
		'formname': 'vacation',
