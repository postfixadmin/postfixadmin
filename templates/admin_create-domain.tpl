...
<table class="form">
   <tr>
      <td align="center" colspan="3">
         <?php print $LANG['pAdminCreate_domain_welcome'] . "\n"; ?>
         <br />
         <br />
      </td>
   </tr>
   <tr>
      <td>
         ...
         <?php print $LANG['pAdminCreate_domain_domain'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pAdminCreate_domain_description'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pAdminCreate_domain_aliases'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pAdminCreate_domain_mailboxes'] . ":\n"; ?>
      </td>
      <td>
...
?>
   <tr>
      <td>
         <?php print $LANG['pAdminCreate_domain_defaultaliases'] . ":\n"; ?>
       </td>
      <td>
   ...
   <tr>
      <td align="center" colspan="3">
         <input type="submit" name="submit" value="<?php print $LANG['pAdminCreate_domain_button']; ?>" />
         </form>
      </td>
   </tr>
</table>
