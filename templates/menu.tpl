            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    {if $authentication_has_role.global_admin}
                        {strip}
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="{#url_list_admin#}"><span class="glyphicon glyphicon-list"
                                                                           aria-hidden="true"></span> {$PALANG.pAdminMenu_list_admin}
                                        </a></li>
                                    <li><a href="{#url_create_admin#}"><span class="glyphicon glyphicon-plus"
                        ...
                        {/strip}
                    {else}
                        <li><a class="btn navbar-btn" href="{#url_main#}"><span class="glyphicon glyphicon-home"
                                                                                aria-hidden="true"></span> {$PALANG.pMenu_main}
                            </a></li>
                    {/if}
                    {* list-domain *}
                    {strip}
                    ...
                    {if $CONF.maillogging==='YES'}
                        <li><a class="btn navbar-btn" type="button"
                               href="maillog.php">
                                ...
                                {$PALANG.pAdminMenu_maillog}</a></li>
                    {/if}
