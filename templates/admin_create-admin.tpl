...
<table class="form">
   <tr>
      <td align="center" colspan="3">
         <?php print $LANG['pAdminCreate_admin_welcome'] . "\n"; ?>
         <br />
         <br />
      </td>
   </tr>
   <tr>
      <td>
         ...
         <?php print $LANG['pAdminCreate_admin_username'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pAdminCreate_admin_password'] . ":\n"; ?>
      </td>
      <td>
   ...
   <tr>
      <td>
         <?php print $LANG['pAdminCreate_admin_password2'] . ":\n"; ?>
      </td>
      <td>
...
?>
   ...
   <tr>
      <td align="center" colspan="3">
         <input type="submit" name="submit" value="<?php print $LANG['pAdminCreate_admin_button']; ?>" />
         </form>
      </td>
   </tr>
</table>
