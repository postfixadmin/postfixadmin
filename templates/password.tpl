<form name="password" method="post" action="" class="form-horizontal">
    ...
    <div id="edit_form" class="card">
        ...
        <div class="card-body enable-asterisk">
            {CSRF_Token}
            <div class="mb-3">
                <label class="col-md-4">{$PALANG.pLogin_username}:</label>
            ...
            <div class="mb-3 {if $pPassword_password_text}is-invalid{/if}">
                <label class="col-md-4" for="fPassword">{$PALANG.pPassword_password}:</label>
            ...
            <div class="mb-3">
                <label class="col-md-4" for="fPassword2">{$PALANG.pPassword_password2}:</label>
