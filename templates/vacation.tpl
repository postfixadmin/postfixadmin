        ...
        <div class="card-body enable-asterisk">
            ...
            {if !$authentication_has_role.user}
                <div class="mb-3">
                    ...
                    <div class="col-md-6 col-sm-8"><p class="form-control-plaintext"><em>{$tUseremail}</em></p></div>
                </div>
            {/if}
            <div class="mb-3">
                ...
                <div class="col-md-6 col-sm-8">
                    ...
                    <div class="input-group ">
                        <input type='datetime-local' name="fActiveFromForm" id="fActiveFromForm" value="{$tActiveFrom}"
                               class="form-control"/>
                    </div>
                </div>
            </div>
