...
print "<b>". $LANG['pOverview_welcome'] . $fDomain . "</b><br />\n";
print $LANG['pOverview_alias_alias_count'] . ": " . $limit['alias_count'] . " / " . $limit['aliases'] . " &nbsp; ";
print $LANG['pOverview_alias_mailbox_count'] . ": " . $limit['mailbox_count'] . " / " . $limit['mailboxes'] . "<br />\n";
print "<p />\n";
...
if (sizeof ($tAlias) > 0)
{
   ...
   print "      <td>" . $LANG['pOverview_alias_address'] . "</td>\n";
   print "      <td>" . $LANG['pOverview_alias_goto'] . "</td>\n";
   print "      <td>" . $LANG['pOverview_alias_modified'] . "</td>\n";
   ...
   for ($i = 0; $i < sizeof ($tAlias); $i++)
   {
      ...
      print "      <td><a href=\"delete.php?delete=" . urlencode ($tAlias[$i]['address']) . "&domain=$fDomain" . "\"onclick=\"return confirm ('" . $LANG['confirm'] . "')\">" . $LANG['del'] . "</a></td>\n";
      print "   </tr>\n";
   }
...
if (sizeof ($tMailbox) > 0)
{
   ...
   print "<table border=\"1\">\n";
   print "   <tr class=\"header\">\n";
   print "      <td>" . $LANG['pOverview_mailbox_username'] . "</td>\n";
   print "      <td>" . $LANG['pOverview_mailbox_name'] . "</td>\n";
   if ($CONF['quota'] == 'YES') print "      <td>" . $LANG['pOverview_mailbox_quota'] . "</td>\n";
   print "      <td>" . $LANG['pOverview_mailbox_modified'] . "</td>\n";
   print "      <td>" . $LANG['pOverview_mailbox_active'] . "</td>\n";
   print "      <td colspan=\"2\">&nbsp;</td>\n";
   print "   </tr>\n";
   ...
   for ($i = 0; $i < sizeof ($tMailbox); $i++)
   {
      ...
      print "      <td><a href=\"delete.php?delete=" . urlencode ($tMailbox[$i]['username']) . "&domain=$fDomain" . "\"onclick=\"return confirm ('" . $LANG['confirm'] . "')\">" . $LANG['del'] . "</a></td>\n";
      print "   </tr>\n";
   }
   print "</table>\n";
   print "</center>\n";
