...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
   ...
   $fDefaultaliases = $_POST['fDefaultaliases'];
   ...
   if (empty ($fDomain) or domain_exist ($fDomain))
   {
      ...
      $pAdminCreate_domain_domain_text = $LANG['pAdminCreate_domain_domain_text_error'];
   }
   ...
   if ($error != 1)
   {
      ...
      if ($result['rows'] != 1)
      {
         $tMessage = $LANG['pAdminCreate_domain_result_error'] . "<br />($fDomain)<br />";
      }
      else
      {
         ...
         $tMessage = $LANG['pAdminCreate_domain_result_succes'] . "<br />($fDomain)</br />";
      }
   }
