...
if ($_SERVER['REQUEST_METHOD'] == "GET")
{
   ...
   if ($fTable == "domain")
   {
      ...
      {
         $error = 1;
         $tMessage = $LANG['pAdminDelete_domain_error'];
      }
      else
      {
         $url = "list-domain.php";
   ...
   if ($fTable == "admin")
   {
      ...
      {
         $error = 1;
         $tMessage = $LANG['pAdminDelete_admin_error'];
      }
      else
      {
         $url = "list-admin.php";
   ...
   if ($fTable == "alias" or $fTable == "mailbox")
   {
      ...
      {
         $error = 1;
         $tMessage = $LANG['pDelete_delete_error'] . "<b>$fDelete</b> (alias)!</font>";
      }
      else
      {
      ...
      if ($result['rows'] == 1)
      {
         ...
         {
            $error = 1;
            $tMessage = $LANG['pDelete_delete_error'] . "<b>$fDelete</b> (mailbox)!</font>";
         }
         else
         {
            $url = "list-virtual.php?domain=$fDomain";
