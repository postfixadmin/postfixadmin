...
{
   $pAdminCreate_admin_username_text = $LANG['pAdminCreate_admin_username_text'];
   $tDomains[] = "";
...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
   ...
   if (!check_email ($fUsername))
   {
      ...
      $pAdminCreate_admin_username_text = $LANG['pAdminCreate_admin_username_text_error1'];
   }
   ...
   if (empty ($fUsername) or admin_exist ($fUsername))
   {
      ...
      $tUsername = $_POST['fUsername'];
      $tDomains = $_POST['fDomains'];
      $pAdminCreate_admin_username_text = $LANG['pAdminCreate_admin_username_text_error2'];
   }
   ...
   if (empty ($fPassword) or ($fPassword != $fPassword2))
	{
      ...
      $tDomains = $_POST['fDomains'];
      $pAdminCreate_admin_username_text = $LANG['pAdminCreate_admin_username_text'];
      $pAdminCreate_admin_password_text = $LANG['pAdminCreate_admin_password_text_error'];
	}
   ...
   if ($error != 1)
   {
      ...
      if ($result['rows'] != 1)
      {
         $tMessage = $LANG['pAdminCreate_admin_result_error'] . "<br />($fUsername)<br />";
      }
      else
      {
         ...
         $tMessage = $LANG['pAdminCreate_admin_result_succes'] . "<br />($fUsername)</br />";
      }
   }
