...
class VacationProxy {
    /**
     * @return bool true if the vacation is removed successfully. Else false.
     */
    ...
    /**
     * @return bool true if vacation stuff is enabled in this instance of postfixadmin
    ...
    /**
     * @return bool true if the user has an active vacation record etc
     */
    ...
    /**
     * @return bool|struct - either array of vacation details or boolean false if the user has none
     */
...
class AliasProxy {
    ...
    /**
     * @return bool true if the user has 'store_and_forward' set.
